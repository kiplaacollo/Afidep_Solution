Page 80102 "Payment Voucher Lines"
{
    AutoSplitKey = true;
    Caption = 'Lines';
    DelayedInsert = true;
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Withholding Tax Code 5%"; Rec."Withholding Tax Code")
                {
                    ApplicationArea = Basic;
                    // Visible = false;
                    Editable = Editable;
                    ...
                    begin
                        ...
                        if WithholdingTaxSetup.FindFirst() then begin
                            ...
                            Rec."Withholding Tax Amount" := Round(Rec."Direct Unit Cost" * (Rec."Withholding Tax Rate %") / 100, 1, '=');
                            Rec."Consultancy Fee" := Round(Rec."Direct Unit Cost" * WithholdingTaxSetup."Consultancy Rate" / 100, 1, '=');
                ...
                field("Consultancy Fee"; Rec."Consultancy Fee")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                    Caption = 'Withholding Tax Amount 5%';
                }
                field("Withholding Tax Code 2%"; Rec."Withholding Tax Code 2")
                {
                    ApplicationArea = Basic;
                    // Visible = false;
                    Editable = Editable;
                    ...
                    begin
                        WithholdingTaxSetup.Reset;
                        WithholdingTaxSetup.SetRange(WithholdingTaxSetup.Code, Rec."Withholding Tax Code 2");

                        if WithholdingTaxSetup.FindFirst() then begin
                            Rec."Withholding Tax Rate %" := WithholdingTaxSetup."Rate %";

                            Rec."Withholding Tax Amount" := Round(Rec."Direct Unit Cost" * (Rec."Withholding Tax Rate %") / 100, 1, '=');
                            Rec."Consultancy Fee 2" := Round(Rec."Direct Unit Cost" * WithholdingTaxSetup."Consultancy Rate" / 100, 1, '=');
                            Rec."Withholdingg Tax(Consultancy/Professional)" := WithholdingTaxSetup."Consultancy Rate";
                            // Rec.Amount := (Rec."Direct Unit Cost" - (Rec."Withholding Tax Amount" + Rec."Consultancy Fee")) / Rec."Currency Factor";
                            // Rec."Net Amount" := Rec.Amount;
                ...
                field("Consultancy Fee 2%"; Rec."Consultancy Fee 2")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                    Caption = 'Withholding Tax Amount 2%';
                }
