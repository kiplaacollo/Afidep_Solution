page 17453 "Timesheet header Project"
{
    ApplicationArea = All;
    Caption = 'Timesheet header Pending Line Manager Approval';
    PageType = List;
    SourceTable = "Timesheet Header";
    SourceTableView = where("Timesheet Status" = filter("Project Manager Approved"));
