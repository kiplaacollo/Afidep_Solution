            ...
            group(Lease)
            {
                ...
                action("Post Lease")
                {
                    ...
                    begin
                        ...
                        Units."Unit Status3":=Units."unit status3"::Occupied;
                        Units.Modify;
                        end;

                        Tenants.Reset;
                        Tenants.SetRange(Tenants."No.",Rec.Tenant);
                        if Tenants.FindFirst then begin
                        Tenants."Unit ID4":=Rec.Unit;
                        Tenants.Unit:=Rec."Unit Name";
                        Tenants."Property ID":=Rec.Property;
                        Tenants."Property Name":=Rec."Property Name";
                        Tenants.Modify;
                        end;
                        Rec.Posted:=true;
                        Rec."Posted Date":=Today;
                        Rec."Posted By":=UserId;
                       Rec. "Lease Status":=Rec."Lease Status";
                        Rec.Modify;
                        end;
                    end;
                }
