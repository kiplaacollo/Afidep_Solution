page 17447 "Payroll RTC"
{
    ApplicationArea = All;
    Caption = 'Payroll RTC', Comment = '{Dependency=Match,"ProfileDescription_SMALLBUSINESS"}';
    PageType = RoleCenter;
    ...
    actions
    {
        ...
        area(sections)
        {
            ...
            group(Timesheets)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'New Timesheet Header ';

                    RunObject = Page TimeSheetsC;
                    //RunPageLink = Status = filter(Open);//
                    //RunPageView = where (Status = filter(New));
                }
...
{
    Caption = 'Payroll RTC';
    RoleCenter = "Payroll RTC";
    ProfileDescription = 'Payroll RTC';
}
