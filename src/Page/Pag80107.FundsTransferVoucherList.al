Page 80107 "Funds Transfer Voucher List"
{
    Caption = 'Funds Transfer Voucher List';
    CardPageID = "Funds Transfer Voucher Card";
    Editable = true;
    PageType = List;
    SourceTable = "Purchase Header";
    SourceTableView = sorting("Document Type", "No.")
                      order(ascending)
                      where("AU Form Type" = filter("Funds Transfer"));
