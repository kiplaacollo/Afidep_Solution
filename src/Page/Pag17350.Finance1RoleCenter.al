page 17350 "Finance 1 Role Center"
{
    ApplicationArea = All;
    Caption = 'Finance 1 Role Center';
    PageType = RoleCenter;
...
profile "Finance 1 Role Center"
{
    RoleCenter = "Finance 1 Role Center";
    Caption = 'Finance 1 Role Center';
    ProfileDescription = 'Finance 1 profile for non payroll processing  users ';
}