Page 80113 "Salary Advance Voucher  Card"
{
    Caption = 'Salary Advance Voucher  Card';
    DeleteAllowed = false;
    PageType = Document;
    ...
    begin
        Rec."AU Form Type" := Rec."au form type"::"Salary Advance";
        PurchasesPayablesSetup.Get;
        Rec."No." := NoSeriesManagement.GetNextNo(PurchasesPayablesSetup."Salary Advance Vouchers Form", Today, true);
