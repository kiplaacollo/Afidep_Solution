Page 50061 "Approved Travel Accounting"
{
    Caption = 'Approved Travel Accounting';
    CardPageID = "Travel Accounting";
    Editable = true;
    PageType = List;
    SourceTable = "Purchase Header";
    SourceTableView = where("AU Form Type" = filter('Imprest Accounting'),
                            Status = filter(Released),Posted=filter(false));
    layout
    {
        area(content)
        {
