Page 50071 "Imprest Accounting Lines"
{
    AutoSplitKey = true;
    Caption = 'Lines';
    DelayedInsert = true;
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Account No New"; Rec."Account No New") { Caption = 'Account No'; }
                field("No."; Rec."No.")
                {
                    ApplicationArea = Advanced;
                    Editable = false;
                ...
                field("Cash Refund  Account"; Rec."Cash Refund  Account")
                {
                    ...
                    begin
                        bank.Reset();
                        bank.SetRange(bank."No.", Rec."Cash Refund  Account");
                        if bank.FindFirst() then begin
                            Rec."Bank Account Name" := bank.Name;
                            Rec."Bank Account Number" := bank."Bank Account No.";
                        end;
                    end;

                }
                field("Bank Account Name"; Rec."Bank Account Name") { ApplicationArea = basic; }
                field("Bank Account Number"; Rec."Bank Account Number") { ApplicationArea = basic; }
