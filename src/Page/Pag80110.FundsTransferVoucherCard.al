Page 80110 "Funds Transfer Voucher Card"
{
    Caption = 'Funds Transfer Voucher Card';
    DeleteAllowed = false;
    PageType = Document;
    ...
    begin
        Rec."AU Form Type" := Rec."au form type"::"Funds Transfer";
        PurchasesPayablesSetup.Get;
        Rec."No." := NoSeriesManagement.GetNextNo(PurchasesPayablesSetup."Funds Transfer Vouchers Form", Today, true);
