...
//                 if ((balance < "Days Applied") and ("Is reimbursement" = false)) then
...
//                 if ((("Available Days" = 0) or ("Days Applied" > "Available Days")) and ("Is reimbursement" = false)) then begin
...
//                     varBranch := HREmp."Global Dimension 1 Code";
//                 end;
...
//                         if ((dates."Period Name" = 'Sunday') and (HRLeaveTypes.Code <> 'CTO')) then
//                             Error('You can not start your leave on a Sunday')
//                         else
//                             if ((dates."Period Name" = 'Saturday') and (HRLeaveTypes.Code <> 'CTO')) then Error('You can not start your leave on a Saturday')
//                     end;

//                 BaseCalendar.Reset;
//                 BaseCalendar.SetFilter(BaseCalendar."Base Calendar Code", varBranch);
...
//                 // Error('You cannot apply Leave past today');
...
//                         "Reliever Email" := HREmp."Company E-Mail";
//                         Rec.Modify(true);
//                     until Rec.Next() = 0;
//             end;
//         }
...
//         {
//         }
//         field(3951; "Reliever Email"; Text[100])
//         {
//         }
...
//         {
//         }
//         field(3958; "Job Tittle"; Text[1000])
//         {
//         }
...
//             Editable = false;
//         }
//         field(3990; SupervisorName; Text[200])
//         {
...
//     trigger OnDelete()
//     begin
//         //IF Status<>Status::Posted THEN ERROR('You cannot delete this leave application');
//     end;
...
//         //codeunit 50013 "Sequential Approval Workflow".HandleApproval(Rec.TableId, Rec."Document Type".AsInteger(), Rec."Document No.", 1);
//     end;
