Table 170160 "Purchase Quote Header"
{
    Caption = 'Purchase Header';
    //LookupPageID = UnknownPage17412;
    ...
    fields
    {
        ...
        field(21; "Expected Closing Date"; Date)
        {
            ...
            begin
                if "Expected Closing Date" < "Expected Opening Date" then
                    Error('Expected Closing Date cannot be before Opening Date');
            end;
        }
        ...
        field(120; Status; Option)
        {
            Caption = 'Status';
            //Editable = false;
            OptionCaption = 'Open,Pending Approval,Approved,Cancelled,Closed';
            OptionMembers = Open,"Pending Approval",Approved,Cancelled,Closed;
        }
        ...
        field(69224; "AGPO Category"; Code[20])
        {
            TableRelation = "AGPO Category";
        }
        field(69225; "Vendor Category"; Code[20])
        {
            TableRelation = "Vendor Category";
        }
        field(51516013; "Purchase Evaluation report"; Boolean)
        {
        }
        field(51516014; "Head of Procurement Opinion"; Boolean)
        {
        }
        ...
        field(99008522; "Expected Opening Time"; Time)
        {
        }
        field(99008523; Note; Text[250])
        {
        }
        field(99008524; Observations; Text[250])
        {
        }
        field(99008525; Recommendations; Text[250])
        {
        }
        field(99008526; "Approval Status"; Option)
        {
            OptionMembers = New,"Pending Approval",Approved,Converted;
            Editable = true;
        }
        field(99008527; Converted; Boolean)
        {
        }
        field(99008528; "Procurement Email Address"; Text[50])
        {
        }
        field(99008529; "Requisition No"; Code[100])
        {
            ...
            var
                ...
                RfqH: Record "Purchase Quote Header";
            ...
            begin
                ...
                reqLine.RESET;
                reqLine.SETRANGE(reqLine."Document No.", "Requisition No");
                IF reqLine.FIND('-') THEN BEGIN
                    ...
                    BEGIN
                        ...
                        PurchHeader.RESET;
                        PurchHeader.SETRANGE(PurchHeader."No.", reqLine."Document No.");
                        IF PurchHeader.FINDSET THEN BEGIN
                            PurchLine2."Shortcut Dimension 1 Code" := PurchHeader."Shortcut Dimension 1 Code";
                            PurchLine2."Shortcut Dimension 2 Code" := PurchHeader."Shortcut Dimension 2 Code";
                            PurchLine2."Shortcut Dimension 3 Code" := PurchHeader."Shortcut Dimension 3 Code";
                            PurchLine2."Shortcut Dimension 4 Code" := PurchHeader."Shortcut Dimension 4 Code";
                            PurchLine2."Shortcut Dimension 5 Code" := PurchHeader."Shortcut Dimension 5 Code";
                        END;
        ...
        field(99008530; "Period Of Contract"; Code[10])
        {
            DataClassification = ToBeClassified;
        }
        field(99008531; "SADO Contact Person"; Text[100])
        {
            DataClassification = ToBeClassified;
        }
        field(99008532; "QUESTIONNAIRE DUE DATE"; Date)
        {
            DataClassification = ToBeClassified;
        }
    ...
    begin
        ...
        if "No." = '' then begin
            ...
            NoSeriesMgt.InitSeries(PurchSetup."RFQ Nos", xRec."No. Series", Today, "No.", "No. Series");
        end;
    ...
    begin
        if xRec."No." <> "No." then begin
            PurchSetup.Get();
            //NoSeriesMgt.TestManual(PurchSetup."RFQ Nos");
        end;
    end;
