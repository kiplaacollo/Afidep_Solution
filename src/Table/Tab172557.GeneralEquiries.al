    ...
    fields
    {
        ...
        field(2; "Member No"; Code[20])
        {
            ...
            begin
                ...
                if ObjCust.Find('-') then begin
                    //     ObjCust.CalcFields(ObjCust."Outstanding Balance", ObjCust."Current Shares", ObjCust."Un-allocated Funds", ObjCust."Shares Retained");
                    ...
                    "ID No" := ObjCust."ID Number";
                    "Phone No" := ObjCust."Cell Phone Number";
        ...
        field(28; "Caller Reffered To"; Code[50])
        {
            ...
            begin
                ...
                ObjCust.Reset;
                ObjCust.SetRange(ObjCust."No.", "Caller Reffered To");
                if ObjCust.Find('-') then begin
                    "Escalated User Email" := ObjCust."E-Mail";
                end;
            end;
        }
        ...
        {
            OptionCaption = ' ,Physical,Phone Call,E-Mail,WhatsApp';
            OptionMembers = " ",Physical,"Phone Call","E-Mail",WhatsApp;
        }
        field(32; "Calling For"; Option)
        {
            OptionCaption = ' ,ITSupport,ERPSupport,Request,Appreciation,Complaint';
            OptionMembers = " ","IT Support","ERP Support",Request,Appreciation,Complaint;
        }
        ...
        field(37; Departments; Option)
        {
            OptionCaption = ' ,Finance and Admin,Resource Mobilisation,Human Resource,Communications,Projects';
            OptionMembers = " ","Finance and Admin","Resource Mobilisation","Human Resource",Communications,Projects;
        }
