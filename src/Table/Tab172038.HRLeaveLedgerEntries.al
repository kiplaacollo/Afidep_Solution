Table 172038 "HR Leave Ledger Entries"
{
    ...
    fields
    {
        ...
        field(7; "Leave Entry Type"; Option)
        {
            ...
            OptionCaption = 'Positive,Negative,Reimbursement,CarryFoward';
            OptionMembers = Positive,Negative,Reimbursement,CarryFoward;
        }
