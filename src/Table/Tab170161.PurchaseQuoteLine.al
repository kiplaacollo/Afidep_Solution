Table 170161 "Purchase Quote Line"
{
    ...
    fields
    {
        ...
        field(6;"No.";Code[20])
        {
            ...
            var
                ...
                ItemCrossReference: Record "Item Category";
        ...
        field(5705;"Cross-Reference No.";Code[20])
        {
            ...
            trigger OnValidate()
            var
                ReturnedCrossRef: Record "Item Category";
            begin
            end;
        }
        ...
        {
            Caption = 'Fund No.';
            //TableRelation = Table170194;

            trigger OnValidate()
            begin
                //CheckOKtoModify(FIELDNAME("Fund No."));
                if "Job No." <> '' then
                  Validate("Job No.");
            end;
        }
        ...
        field(37001059;"Dimension Speedkey Code";Code[10])
        {
            ...
            begin
                ...
                //  VALIDATE("Shortcut Dimension 1 Code", DimensionSpeedkey."Global Dimension 1 Code");
                //  VALIDATE("Shortcut Dimension 2 Code", DimensionSpeedkey."Global Dimension 2 Code");
                //  VALIDATE("Shortcut Dimension 3 Code", DimensionSpeedkey."Global Dimension 3 Code");
                //  VALIDATE("Shortcut Dimension 4 Code", DimensionSpeedkey."Global Dimension 4 Code");
                //  VALIDATE("Shortcut Dimension 5 Code", DimensionSpeedkey."Global Dimension 5 Code");
                //  VALIDATE("Shortcut Dimension 6 Code", DimensionSpeedkey."Global Dimension 6 Code");
                //  VALIDATE("Shortcut Dimension 7 Code", DimensionSpeedkey."Global Dimension 7 Code");
                //  VALIDATE("Shortcut Dimension 8 Code", DimensionSpeedkey."Global Dimension 8 Code");
                // END;
            end;
        }
