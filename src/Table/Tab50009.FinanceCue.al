table 50009 "FinanceCue"
{
    ...
    fields
    {
        field(200; "Approval Request"; Integer)
        {
            CalcFormula = Count("Approval Entry");
            Caption = 'Request To Approve';
            FieldClass = FlowField;
        }
        field(201; "Payment Voucher Pending Approval"; Integer)
        {
            CalcFormula = Count("Purchase Header" WHERE("AU Form Type" = FILTER('Payment Voucher')));
