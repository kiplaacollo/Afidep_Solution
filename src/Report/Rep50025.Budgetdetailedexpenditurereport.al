report 50025 "Detailed Budget Line Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/DetailedBudgetLineReport.rdlc';
    ApplicationArea = Basic, Suite;
    Caption = 'Detailed Budget Line Report';
    ...
    dataset
    {
        ...
        dataitem("G/L Entry"; "G/L Entry")
        {
            ...
            begin
                ...
                purchaseheader.SetFilter(purchaseheader."No.", "External Document No.");
                if purchaseheader.FindFirst() then begin
                    payee2 := purchaseheader."Payee Naration";
                end;
            end;
