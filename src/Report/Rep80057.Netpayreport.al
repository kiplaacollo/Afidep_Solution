...
Report 80057 "Payroll Net P_AU"
{
    //RDLCLayout = './Layouts/Payroll Summary P_AU.rdlc';
    RDLCLayout = './Layouts/NetPay_AU.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Payroll Employee_AU"; "Payroll Employee_AU")
        {
            ...
            column(EmployeeName; "Payroll Employee_AU"."Full Name") { }
            column(ID_No_Passport_No; "Payroll Employee_AU"."ID No/Passport No") { }
            column(BankName; "Payroll Employee_AU"."Bank Name") { }
            column(bankCode; "Payroll Employee_AU"."Bank Code") { }
            column(AccountNo; "Payroll Employee_AU"."Bank Account No") { }
            column(BankBranch; "Payroll Employee_AU"."Branch Name") { }
            column(BranchCode; "Payroll Employee_AU"."Branch Code") { }
