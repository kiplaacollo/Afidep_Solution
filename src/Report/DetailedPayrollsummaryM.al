...
Report 17309 "Detailed Payroll Summary M"
{
    RDLCLayout = './Layouts/Detailed Payroll Summary M.rdlc';
    DefaultLayout = RDLC;
    Caption = 'Detailed Payroll Summary Malawi';
    ...
    dataset
    {
        dataitem("Payroll Monthly Trans_AU"; "Payroll Monthly Trans_Malawi")
        {
            ...
            column(EmployerPension1; EmployerPension1) { }
            ...
            begin
                //  if PayrollEmployee_AU.Status <> PayrollEmployee_AU.Status::Active then CurrReport.Skip;
                Currency := 0;
                PayrollEmployee_AU.Reset();
                PayrollEmployee_AU.SetRange("No.", "Payroll Monthly Trans_AU"."No.");
                PayrollEmployee_AU.SetRange(PayrollEmployee_AU.Status, PayrollEmployee_AU.Status::Active);
                ...
                if PayrollCal.FindFirst() then begin
                    Currency := PayrollCal."Malawi Currency Code";
                end;
                //Requester details
                Payroll.Reset;
    ...
    var
        ...
        PayrollCal: Record "Payroll CalenderMalawi";
        EmployerPension: Decimal;
        AdmPension: Decimal;
        VATFee: Decimal;
        EmployerPension1: Decimal;
        ApprovalEntry: Record "Approval Entry";
        Payroll: Record "Payroll M";
