...
Report 172152 "SHIF Schedule Ver1"
{
    //
    RDLCLayout = 'Layouts/SHIFScheduleVer1.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Payroll Employee_AU"; "Payroll Employee_AU")
        {
            ...
            begin
                ...
                PeriodTrans.SetFilter(PeriodTrans."Transaction Code", 'SHIF');
                PeriodTrans.SetRange(PeriodTrans.Grouping, 6);
                PeriodTrans.SetRange(PeriodTrans.SubGrouping, 11);
