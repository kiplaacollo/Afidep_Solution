report 50095 "Malawi Pension"
{
    Caption = 'Malawi Pension';

    RDLCLayout = './Layouts/Malawi Pension.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Payroll Employee_AU"; "Payroll Employee_AU")
        {
            ...
            begin
                ...
                if UserSetup."View Malawi Payroll" = false then
            ...
            begin
                ...
                PayrollMonthly.SetRange(PayrollMonthly."Group Text", 'BASIC PAY');
                if PayrollMonthly.Find('-') then begin

                    PensionAdministrative := "Payroll Employee_AU"."Pension Administrative Fee" / 100 * PayrollMonthly.Amount;
                    VATOnPension := "Payroll Employee_AU"."VAT Administrative Fee" / 100 * PensionAdministrative;
                    MalawiEployeePen := "Payroll Employee_AU"."Pension %-Employee" / 100 * PayrollMonthly.Amount;
                    MalawiPension2 := "Payroll Employee_AU"."Pension %-Employer" / 100 * PayrollMonthly.Amount;
