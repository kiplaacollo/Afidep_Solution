report 50022 "Budget Line Detailed Exp"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/BudgetLine Detailed ExpReport.rdlc';
    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            dataitem(PageCounter; "Integer")
            {
                ...
                {
                    DataItemLink =  "Global Dimension 2 Code" = FIELD("Global Dimension 2 Filter"), "Business Unit Code" = FIELD("Business Unit Filter");
