            ...
            begin
                ...
                if PayrollEmployee.Find('-') then begin
                    ...
                    if PayrollMonthly.Find('-') then begin
                        EmployerPen := 0.1 * PayrollMonthly.Amount;
                        // Message('Emp. Pen %1', EmployerPen);
                        // EmployerPen := PayrollEmployee."Pension %-Employer" / 100 * PayrollEmployee."Basic Pay(LCY)";
                    end;
                end;
                EmployeePension := 0;
                EmployerPension := 0;
                ...
                PayrollMonthly.SetRange(PayrollMonthly."No.", "Payroll Employee_AU"."No.");
                PayrollMonthly.SetRange(PayrollMonthly."Payroll Period", Period);
                PayrollMonthly.SetRange(PayrollMonthly."Transaction Code", 'D004');
                if PayrollMonthly.Find('-') then begin
                    EmployeePension := PayrollMonthly.Amount;
                    EmployerPension := EmployerPen;
