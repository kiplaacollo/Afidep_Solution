...
// 	{
// 		type(ForNav.Report_6_0_0_2068; ForNavReport80031_v6_0_0_2068){}   
// 	}
// } // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 80031 "Payslips W_AU"
{
    RDLCLayout = './Layouts/Payslips W_AU.rdlc';
    DefaultLayout = RDLC;
    ...
    begin
        if UserSetup.Get(UserId) then begin
            if UserSetup."Run payslip" = false then Error('You dont have permissions to run the report, Contact your system administrator! ')
        end;
    ...
    // var 
    // 	[WithEvents]
    // 	ReportForNav : DotNet ForNavReport80031_v6_0_0_2068;
