Report 50080 "Create Time SheetT"
{
    Caption = 'Create Time Sheets Custom';
    // ------------------------------------------------------------------------------------------------
    ...
    dataset
    {
        dataitem("Integer"; "Integer")
        {
            ...
            dataitem(Resource; Resource)
            {
                ...
                begin
                    StartingDate := CalcDate('<10D>', StartingDate);
                end;
            ...
            trigger OnAfterGetRecord()
            begin
                EndingDate := CalcDate('<10D>', StartingDate) - 1;
            end;
    ...
    begin
        ...
        EndingDate := CalcDate('<10D>', StartingDate);

        LastDate := StartingDate;
        for i := 1 to NoOfPeriods do
            LastDate := CalcDate('<10D>', LastDate);
    ...
    var
        ...
        DescriptionTxt: Label 'Month %1', Comment = '%1 - month number';
